...
def soin(Player):
    ...
    if choice == "1":
        ...
        print('\x1b[0;32;40m', "Vous utilisez une potion de vie et vous récupérez 30 PV",'\x1b[0m')
        sleep(1)
        return
    if choice == "2":
        Potion.GetSoin(potion_int_de_vie, Player)
        Player.potion.remove(potion_int_de_vie.nom)
        print('\x1b[0;32;40m',"Vous utilisez une potion intermédiaire de vie et vous récupérez 100 PV",'\x1b[0m')
        sleep(1)
        return
    if choice == "3":
        Potion.GetSoin(potion_leg_de_vie, Player)
        Player.potion.remove(potion_leg_de_vie.nom)
        print('\x1b[0;32;40m',"Vous utilisez une potion légendaire de vie et vous récupérez 200 PV",'\x1b[0m')
        sleep(1)
        return
