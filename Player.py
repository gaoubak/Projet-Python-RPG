...
potion_de_vie = Potion(100, 30, "potion_de_vie")

potion_int_de_vie = Potion(150, 100, "potion_int_de_vie")

potion_leg_de_vie = Potion(200, 200, "potion_leg_de_vie")
...
class Player:
    ...
    def __init__(self):
        self.nom = "_"
        self.gold = 10
        self.arme = ["fourchette"]  # se trouve dans la liste pour ajoute du stuff
        self.armure = ["calecon_troue"]  # se trouve dans la liste pour ajoute du stuff
        self.potion = ["potion_de_vie"]  # se trouve dans la liste pour ajoute du stuff
        #self.etat = "Normal"
        self.classe = "_"
        self.INT = 0
        self.VIT = 0
    ...
    # il faut maintenant choisir votre class ce qui changera la maniere de jouer
    ...
    # le joueur doit pouvoir voir ce qu'il possede
    ...
    def inventaire(self):
        ...
        while choice != "a":
            choice = input()
# Des phrases au hasard pour le marchand.
