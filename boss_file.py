...
# Nous allons préparer les boss et les combats liés au boss.
# Boss final : Brontis, la sentinelle
# Boss secret : Valentin, le developpeur
...
def quest_fabrice(m, Player):
    ...
    if "LBFDP" in Player.arme:
        ...
        sleep(2)
        print("Je ne sais pas si tu te rends compte mais personne n'avait reussi à accéder à la",'\x1b[0;33;40m',"bibliothèque secrète",'\x1b[0m',"auparavant.")
        sleep(2)
        print("Je vais maintenant te débloquer l'accès à la suite de la carte")
        sleep(2)
        print("...")
        sleep(2)
        print("c'est fait.. dirige toi vers l'est afin de continuer ton aventure")
        sleep(2)
        print("D'ailleurs... vu que tu m'as l'air sympathique...")
        sleep(2)
        print("Je vais te réveler un petit",'\x1b[0;33;40m',"secret.",'\x1b[0m')
        sleep(2)
        print("Si jamais le",'\x1b[0;33;40m',"BOSS FINAL.",'\x1b[0m',"te demande si tu as quelque chose à lui dire." )
        sleep(2)
...
def Hugo_A():
    ...
    print("Salut petit noob")
    sleep(2)
    print("Que fais-tu sur mon territoire?")
    sleep(2)  
    print("Je suis le maitre des lieux!!") 
    sleep(2)
    print("je suis certain que c'est,"'\x1b[0;33;40m',"Fabrice",'\x1b[0m'," qui t'envoie car il a peur de m'affronter..")
    sleep(2)
    print("HA HA HA HA HA")
    sleep(2)
    print("TU CROYAIS POUVOIR PASSER SANS PROBLEME ?")
    sleep(2)
    print("Si tu me bats, tu auras accès à la",'\x1b[0;33;40m',"MATRICE DU SAVOIR",'\x1b[0m')
    sleep(2)
    print("")
    print("")
    return
...
def quest_rijenth(m, Player):
    ...
    while choice not in ["oui","non"]:
        ...
        print('\x1b[0;30;47m',"(Lui demander ce qui lui arrive ?)[oui][non]",'\x1b[0m')
        choice = input()
    if choice == "non":
        print('\x1b[0;33;40m',"[Rijenth]:",'\x1b[0m')
        print("...")
    ...
    if choice == "oui":
        print('\x1b[0;33;40m',"[Rijenth]:",'\x1b[0m')
        print("Enfaite... Je jouais avec le",'\x1b[0;33;40m',"ballon de basket",'\x1b[0m',"d'un ami...")
        sleep(2)
        ...
        if choice == "oui":
            ...
            sleep(3)
            print("J'ai en face de moi une personne, qui semble vouloir passer à la suite du jeu.")
            sleep(3)
            ...
            sleep(3)
            print("Du coup, on vas jouer à un",'\x1b[0;33;40m',"jeu tout bête.",'\x1b[0m')
        ...
        if choice == "non":
            ...
            sleep(3)
            print("Si seulement une",'\x1b[0;33;40m',"âme charitable",'\x1b[0m',"pouvait s'en occuper à ma place...")
...
def jeu_tout_bête():
    ...
    while i < 5:
        ...
        if i >= 1 and i <= 4:
            ...
            print("")
            sleep(2)
            print("J'ai choisi un nombre compris entre",'\x1b[0;32;40m',"0",'\x1b[0m',"et",'\x1b[0;32;40m', liste_chiffre_jeu,'\x1b[0m',"à toi de le deviner.") 
            print("")
        else: 
            print("J'ai choisi un nombre compris entre",'\x1b[0;32;40m',"0",'\x1b[0m',"et",'\x1b[0;32;40m', liste_chiffre_jeu,'\x1b[0m',"à toi de le deviner.") 
            print("")
...
# Cette fonction permet de récuperer le resultat en fonction du choix du joueur. (reussite, echec, plainte)
...
def quest_kader(m,Player):
    ...
    if "ballon_de_basket" in Player.arme:
        print("Super !! Tu as retrouvé mon",'\x1b[0;33;40m',"ballon de basket",'\x1b[0m',"!")
        sleep(2)
        m[9][23] = "➡"
        m[9][24] = "-"
        m[8][23] = "═"
    ...
    if "ballon_de_basket" not in Player.arme:
        ...
        sleep(2)
        print("Je voudrais bien t'aider mais j'ai perdu mon",'\x1b[0;33;40m',"ballon de basket",'\x1b[0m',"!!")
        sleep(2)
        print("Oui... il y a des urgences plus importantes que d'autres...")
        sleep(3)
        print("Si tu le retrouves, alors je t'ouvrirai la voie.")
        sleep(3)
        print("Celon",'\x1b[0;33;40m',"l'un de mes collègues",'\x1b[0m',"le ballon est dans l'un des deux terrains de basket. (Les zones remplies de 'x')")
        sleep(3)
        print("Mais comme tu peux le voir, ces zones sont actuellement inaccessibles.")
        sleep(4)
        print("Deux",'\x1b[0;33;40m',"leviers",'\x1b[0m',"sont cachés sur cette carte.")
        sleep(3)
        print("Cherche et active les deux",'\x1b[0;33;40m',"leviers",'\x1b[0m',"pour accéder aux deux terrains.")
        print('\x1b[0;30;47m'+'Appuyez sur [A] pour continuer'+'\x1b[0m')
        choice = input()
        choice = choice.lower()
        while choice != "a":
...
def entree_utilisateur(Player):
    ...
    # si vous pas plus de 4 bonne reponse vous affrontez Loic et faite attention il est enervé
    score = 0
    # Question 1
    print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
    print("")
    ...
    sleep(2)
    print("")
    liste_q0 = ["1 - echo 'Hello World'","2 - print('Hello World')  ","3 - p('Hello World')","4 - echo('Hello World');"]
    print(liste_q0[0])
    print(liste_q0[1])
    print(liste_q0[2])
    print(liste_q0[3])
    ...
    print("")
    liste_q1 = ["1 - /*This is a comment*/ ", "2 - //This is a comment ", "3 - #This is a comment", ]
    print(liste_q1[0])
    print(liste_q1[1])
    print(liste_q1[2])
    entree_utilisateur = int(input("Entrer votre choix: "))
    ...
    if entree_utilisateur == 3:
        print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
        print("Pas mal", Player.nom, "je vois que je n'ai pas parler à l'oreille d'un sourd.")
        sleep(1)
        score += 1
    else:
        print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
    ...
    if entree_utilisateur == 1:
        ...
        print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
        print("Mais comment avez-vous pu faire tout un RPG sans savoir celà... Du copier-coller ? ")
        sleep(2)
    # Question 4
    ...
    liste_q4 = ["1 - while (x > y) ", "2 - while x > y:   ", "3 - x > y while {", "4 - while x > y { "]
    print(liste_q4[0])
    print(liste_q4[1])
    print(liste_q4[2])
    print(liste_q4[3])
    ...
    if entree_utilisateur == 2:
        print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
        print("Parfait", Player.nom, "Mais j'espère que vous n'êtes pas aller chercher la réponse sur internet !")
        sleep(1)
        score += 1
    else:
        print('\x1b[0;33;40m',"[Loïc, le professeur]:",'\x1b[0m')
    ...
    liste_q5 = ["1 - for x > y: ", "2 - for each x in y:   ", "3 - for x in y:  ",]
    print(liste_q5[0])
    print(liste_q5[1])
    print(liste_q5[2])
    entree_utilisateur = int(input("Entrer votre choix: "))
...
def random_phrase_valentin():
    ...
    if random == 0:
        ...
        print("Le combat avait déjà commencer ?","Je ne l’avais même pas remarquer...")
        sleep(2)
        return
    if random == 1:
        print ('\x1b[0;33;40m',"[Valentin, Le ninja ctrlc_ctrlv]:",'\x1b[0m')
...
def boss_valentin(Player):
    ...
    print("")
    sleep(2)
    print("Je vois que tu as bien retenu le code secret que j’ai laissé à",'\x1b[0;33;40m',"Fabrice.",'\x1b[0m')
    sleep(2)
    print("Durant des années, on m’a enfermé ici, sous la menace de",'\x1b[0;33;40m',"l'EPEE LEGENDAIRE.",'\x1b[0m')
    sleep(2)
    print("")
